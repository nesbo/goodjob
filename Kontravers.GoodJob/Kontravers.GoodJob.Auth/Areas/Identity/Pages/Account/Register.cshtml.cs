        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user, new Claim("userId", userId));
                    ...
                    var userCreatedEvent = new UserCreatedEvent(_clock.UtcNow, user.UserName!,
                        user.Email!, "1", userId);
                    await _eventPublisher.PublishAsync(userCreatedEvent, default);
